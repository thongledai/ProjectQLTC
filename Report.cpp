...
Report::Report(const string& fromDate, const string& toDate) {
...
void Report::build(const vector<Transaction*> transactions) {
    this->totalIncome = 0;
    this->totalExpense = 0;
    this->netChange =0;
...
long Report::getTotalIncome() const  { return this->totalIncome; }
long Report::getTotalExpense() const { return this->totalExpense; }
long Report::getNetChange() const    { return this->netChange; }
